...
summary: What are the risks running a Drupal 6 site in the wild after EOL.
...
Drupal 6 likes a [small range](https://www.drupal.org/requirements) of PHP versions --  5.25 <= your site < 5.3.
...
development took place before RWD, the community was able to evolve with it and 
 provide solidofferings for responsive themes and frameworks in the Drupal 7 
...
Even greater disparities exist when comparing the object-oriented 8 to 6.
